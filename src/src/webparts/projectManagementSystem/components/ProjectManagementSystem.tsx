...
export default class ProjectManagementSystem extends React.Component<IProjectManagementSystemProps, {}> {
  public render(): React.ReactElement<IProjectManagementSystemProps> {
    ...
    return (
      <section className={`${styles.projectManagementSystem} ${hasTeamsContext ? styles.teams : ''}`}>
